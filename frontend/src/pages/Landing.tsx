      ...
      <section className="relative bg-black text-white py-28 mt-24">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <h2 className="text-4xl md:text-5xl font-semibold font-geist leading-tight">
                <span className="text-white/30">Everything You <br /> Need To <br /></span>{" "}
                <span className="text-white">Stay Interview-Ready</span>
              </h2>
            </div>


            <div className="flex flex-col h-full">
              <p className="text-white/60 font-geist text-lg leading-relaxed max-w-md mt-auto">
          ...
          <div className="grid md:grid-cols-2 gap-20 mt-10 font-geist">
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                className="relative mt-10 font-geist"
              >
